...
#ifdef USE_SALIENCY
    mvKeysRight(F.mvKeysRight), NLeft(F.Nleft), NRight(F.Nright), mTrl(F.GetRelativePoseTrl()), mnNumberOfOpt(0), mbHasVelocity(false), mvSaliencySpatial(F.mvSaliencySpatial)
#else
